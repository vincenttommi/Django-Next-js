...
export default function HomeReviews() {
    return (
        <section className="container my-5">
            <h2 className="my-5 text-center" style={{ color: '#68004c' }}>Reviews <Link href="/reviews" className="float-end  fs-4  btn text-white" style={{'backgroundColor': '#68004c' }}>View All</Link></h2>
